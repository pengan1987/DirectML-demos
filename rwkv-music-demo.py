...
# MODEL_FILE = 'E:\\rwkv-4-music\\RWKV-4-MIDI-120M-v1-20230714-ctx4096' # MIDI model
MODEL_FILE = 'E:\\rwkv-4-music\\RWKV-4-ABC-82M-v1-20230805-ctx1024.pth' # ABC model (see https://abc.rectanglered.com)

ABC_MODE = ('-ABC-' in MODEL_FILE)
MIDI_MODE = ('-MIDI-' in MODEL_FILE)

model = RWKV(model=MODEL_FILE, strategy='dml fp32')
pipeline = PIPELINE(model, "E:\\rwkv-4-music\\tokenizer-midi.json")
